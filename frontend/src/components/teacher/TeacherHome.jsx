  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const analyticsResponse = await axios.get("http://localhost:4000/api/analytics/count", {
          headers: {
        ...
        const recentCompResponse = await axios.get("http://localhost:4000/api/analytics/recent", {
          headers: {
            "Cache-Control": "no-cache, no-store, must-revalidate",
            Pragma: "no-cache",
            Expires: "0",
        ...
        const recentRegResponse = await axios.get("http://localhost:4000/api/analytics/recentreg", {
          headers: {
            "Cache-Control": "no-cache, no-store, must-revalidate",
            Pragma: "no-cache",
            Expires: "0",
